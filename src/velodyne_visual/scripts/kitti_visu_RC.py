...
# 		# all_points = np.empty([1,4],dtype=float)
...
# 			# print vcount
# 			try:
# 				all_points[frame_count] = np.empty([1,4],dtype=float)
# 			except:
# 				continue
...
# 			# all_points = np.vstack([all_points, transformed_points])
# 			# all_points = np.delete(all_points, (0), axis=0)
# 			all_points[frame_counts] = transformed_points
...
# 			processed_data = pc2.create_cloud_xyz32(header, current_set)
# 			# [[1, 1, 1]]
# 			# a = [[1, 1, 1]]
# 			# b = type(a)
# 			# print b
